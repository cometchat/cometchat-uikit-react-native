...
export const IncomingCall = (props: IncomingCallProps) => {
    ...
    const _rejectCall = () => {
        ...
        CometChat.rejectCall("v1.us.239414efb0e4882a.1693576153e0dfe098a411c7c30f25e4382a150c64104f228e", CometChat.CALL_STATUS.REJECTED).then(
            call => {
                // console.log("Call rejected successfully", call);
            },
            err => {
                // console.log("Call rejection failed with error:", err);
                //   onError && onError(err);
            }
        )
